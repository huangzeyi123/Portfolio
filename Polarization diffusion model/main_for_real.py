...
if __name__ == "__main__":
    ...
    parser.add_argument('--noisy_path', default='./pre-trained/CC.pt', type=str, help='for example: ./data/CC/noisy/')
    parser.add_argument('--datatype', default='CC', type=str, help='CC/PolyU/FMDD')
    parser.add_argument('--S_t', default=2, type=int, help='sampling times in one inference')
    parser.add_argument('--R_t', default=500, type=int, help='repetition times of multiple inferences')
